<template>
  ...
  <div class="container-fluid d-flex gap-2 flex-column file-container" v-if="!selectedFile">
    <div class="card" v-for="file in files" :key="file.file_id">
      <div class="card-body d-flex align-items-center">
        <p class="flex-grow-1 mb-0">{{ file.name }}</p>
        <div class="d-flex gap-2">

          <button @click="download(file)" type="button" class="btn btn-outline-success d-flex gap-2 align-items-center">
